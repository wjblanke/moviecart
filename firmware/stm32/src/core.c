 ...
 *   $F117–$F119  jmp $F160 (end of picture)
 *   $F140–$F15F  32-byte packed tail (after the 6 cart overscan samples)
 *   $F160–$F1D8  overscan head: 6 lines AUDV0 + copy 32 bytes, joystick, RTS
 *   $F200+       RamKernel source (74 bytes, copied to $80)
 *   $FE00–$FEFF  gstore (SWCHA/SWCHB/INPT4/INPT5)
 *   $FFFA–$FFFF  reset → $F000
 *
 * RIOT after copy: kernel $80–$C9, pack $CA–$E9, FIELD $FB, AUDIDX $FC.
...
#define MC_OFF_OSHEAD_AUD5	0x19bu
#define MC_OFF_OSHEAD_RTS	0x1d8u
...
/*
 * ColdStart only ($F000–$F04A). Copies 74 bytes from $F200 → $80, jmp $80.
...
static const uint8_t mc_boot_rom[MC_OFF_BOOT_END + 1]
	...
	0x21, 0x85, 0x02, 0x85, 0x2a, 0xa2, 0x0c, 0xca, 0xd0, 0xfd, 0x85, 0x2b, 0xea, 0xea, 0xa2, 0x49,
	0xbd, 0x00, 0xf2, 0x95, 0x80, 0xca, 0x10, 0xf8, 0x4c, 0x80, 0x00
};

/*
 * First 6 overscan lines (cart, after the 192-line kernel). Each line writes
 * one tail sample to AUDV0 and copies 6 then 5 pack bytes (32 total).
 */
static const uint8_t mc_oshead[] __attribute__((section(".ccmram"))) = {
	0xa9, 0x00, 0x85, 0x1b, 0x85, 0x1c, 0x85, 0x1b, 0xa2, 0x00, 0xa0, 0x02,
	0xa9, 0x00, 0x85, 0x19, 0xbd, 0x40, 0xf1, 0x95, 0xca, 0xe8, 0xbd, 0x40,
	0xf1, 0x95, 0xca, 0xe8, 0xbd, 0x40, 0xf1, 0x95, 0xca, 0xe8, 0xbd, 0x40,
	0xf1, 0x95, 0xca, 0xe8, 0xbd, 0x40, 0xf1, 0x95, 0xca, 0xe8, 0xbd, 0x40,
	0xf1, 0x95, 0xca, 0xe8, 0x88, 0x85, 0x02, 0xd0, 0xd3, 0xa0, 0x04, 0xa9,
	0x00, 0x85, 0x19, 0xbd, 0x40, 0xf1, 0x95, 0xca, 0xe8, 0xbd, 0x40, 0xf1,
	0x95, 0xca, 0xe8, 0xbd, 0x40, 0xf1, 0x95, 0xca, 0xe8, 0xbd, 0x40, 0xf1,
	0x95, 0xca, 0xe8, 0xbd, 0x40, 0xf1, 0x95, 0xca, 0xe8, 0x88, 0x85, 0x02,
	0xd0, 0xd9, 0xae, 0x80, 0x02, 0xbd, 0x00, 0xfe, 0xae, 0x82, 0x02, 0xbd,
	0x00, 0xfe, 0xa6, 0x0c, 0xbd, 0x00, 0xfe, 0xa6, 0x0d, 0xbd, 0x00, 0xfe,
	0x60
};

/*
 * RamKernel at RIOT $80. Play remaining OS 23/24 + VS 3 + VB 37 from pack
 * (A12 low). No preroll. Even: 63 nibbles (drop 64th). Odd: 64.
 */
static const uint8_t mc_ram_kernel[] __attribute__((section(".ccmram"))) = {
	...
	0xe8, 0x20, 0xb0, 0x00, 0xa9, 0x02, 0x85, 0x00, 0xa2, 0x03, 0x20, 0xb0,
	0x00, 0x86, 0x00, 0xa9, 0x02, 0x85, 0x01, 0xa2, 0x25, 0x20, 0xb0, 0x00,
	0x86, 0x01, 0x86, 0xfc, 0xa2, 0x07, 0xca, 0xd0, 0xfd, 0x4c, 0x80, 0x00,
	0xa5, 0xfc, 0x4a, 0xa8, 0xb9, 0xca, 0x00, 0x90, 0x05, 0x4a, 0x4a, 0x4a,
	0x4a, 0x2c, 0x29, 0x0f, 0x85, 0x19, 0xe6, 0xfc, 0x85, 0x02, 0xca, 0xd0,
	0xe7, 0x60
};
